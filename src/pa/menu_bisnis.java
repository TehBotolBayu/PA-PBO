 ...
 * @author USER
 */
public class menu_bisnis extends javax.swing.JFrame {
    static  UserPersonal userr = new UserPersonal();
    static  Bisnis bisniss = new Bisnis();
...
//    }
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addComponent(mkurs, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addComponent(mubah, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addGap(23, 23, 23)
                                .addComponent(mhapus, javax.swing.GroupLayout.PREFERRED_SIZE, 119, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addGap(23, 23, 23)
                                .addComponent(mkeuangan, javax.swing.GroupLayout.PREFERRED_SIZE, 119, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(mlihat, javax.swing.GroupLayout.DEFAULT_SIZE, 40, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void mlihatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mlihatActionPerformed
       ...
       menu_akun.txtDataLogin.setText("User Bisnis".toUpperCase());
        try {
            bisniss.LihatAkun();
        } catch (IOException ex) {
            Logger.getLogger(menu_bisnis.class.getName()).log(Level.SEVERE, null, ex);
        }
        this.dispose();
    ...
    private void mubahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mubahActionPerformed
        ...
        menu_ubah.txtDataLogin.setText("User Bisnis".toUpperCase());
        for (int i=0; i <  bisnis.size(); i++){
            if (Main.idlogin.equals(bisnis.get(i).getId_user())){
               
                menu_ubah.txtNama.setText(bisnis.get(i).getNamaBisnis());
                menu_ubah.txtNomorHp.setText(bisnis.get(i).getNomorhp());
                menu_ubah.txtAlamat.setText(bisnis.get(i).getAlamat());
                menu_ubah.txtUsername.setText(bisnis.get(i).getUsername());
                menu_ubah.txtpass.setText(bisnis.get(i).getPass());
